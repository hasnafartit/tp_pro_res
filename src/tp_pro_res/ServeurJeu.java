					...
					if (correctFormatRequest) {
						...
						if(fin == false) {
							if(nombre > nombreSecret) {
								pw.println("Votre nombre "+nombre+" est supérieur au nombre secret");
							}else if(nombre < nombreSecret) {
								pw.println("Votre nombre "+nombre+" est inférieur au nombre secret");
							}else {
								pw.println("Bravo, vous avez gagné le nombre secret est  :"+nombre );
								gagnant = ipClient;
